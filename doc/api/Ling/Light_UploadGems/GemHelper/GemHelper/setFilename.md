...
GemHelper::setFilename
================



GemHelper::setFilename — Sets the filename.
...
public [GemHelper::setFilename](https://github.com/lingtalfi/Light_UploadGems/blob/master/doc/api/Ling/Light_UploadGems/GemHelper/GemHelper/setFilename.md)(string $filename) : void
...
Source Code
===========
See the source code for method [GemHelper::setFilename](https://github.com/lingtalfi/Light_UploadGems/blob/master/GemHelper/GemHelper.php#L86-L89)
