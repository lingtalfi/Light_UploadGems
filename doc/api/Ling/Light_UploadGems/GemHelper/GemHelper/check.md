...
GemHelper::check — Throws an exception if the object is not properly configured.
...
private [GemHelper::check](https://github.com/lingtalfi/Light_UploadGems/blob/master/doc/api/Ling/Light_UploadGems/GemHelper/GemHelper/check.md)() : void
