...
LightUploadGemsService::getHelper
================



LightUploadGemsService::getHelper — Returns a GemHelperInterface associated with the given gemId, or throws an exception otherwise.
